...
// # Layout
//
//   - server.go    — Server struct, New, and the per-session JSONL
...
//
// server.go is what the server IS; serve.go is what it DOES at
