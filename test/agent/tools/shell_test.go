...
func TestBashSimple(t *testing.T) {
	...
	out, err := tool.Invoke(context.Background(), `{"command":"echo hello","intent":"test"}`)
	if err != nil {
...
func TestBashWorkingDirectory(t *testing.T) {
	...
	tool := tools.Bash(dir, tools.BashOptions{})
	out, err := tool.Invoke(context.Background(), `{"command":"ls marker.txt","intent":"test"}`)
	if err != nil {
		t.Fatalf("Execute: %v", err)
	}
...
func TestBashTimeout(t *testing.T) {
	...
	_, err := tool.Invoke(context.Background(), `{"command":"sleep 5","timeout":1,"intent":"test"}`)
	if err == nil {
...
func TestBashFailure(t *testing.T) {
	...
	_, err := tool.Invoke(context.Background(), `{"command":"exit 1","intent":"test"}`)
	if err == nil {
...
func TestBashStderrCaptured(t *testing.T) {
	...
	out, err := tool.Invoke(context.Background(), `{"command":"echo err 1>&2","intent":"test"}`)
	if err != nil {
		t.Fatalf("Execute: %v", err)
	}
...
func TestBashContextCancel(t *testing.T) {
	...
	_, err := tool.Invoke(ctx, `{"command":"sleep 10","intent":"test"}`)
	if err == nil {
