...
func runAgentCaptureFirstToolError(t *testing.T, ag *agentcore.Agent, msg string) string {
	t.Helper()
...
func TestAgentUnknownToolErrorListsAvailableTools(t *testing.T) {
	...
	ag.WithTool(agentcore.ToolFunc{N: "bash", Fn: func(_ context.Context, _ string) (string, error) { return "ok", nil }})
	ag.WithTool(agentcore.ToolFunc{N: "read", Fn: func(_ context.Context, _ string) (string, error) { return "ok", nil }})
	ag.WithTool(agentcore.ToolFunc{N: "write", Fn: func(_ context.Context, _ string) (string, error) { return "ok", nil }})
...
func TestAgentBatchContinuesAfterOneToolFails(t *testing.T) {
	...
	ag := newTestAgent(core, "test-model")
	ag.WithTool(agentcore.ToolFunc{N: "read", Fn: func(_ context.Context, _ string) (string, error) {
		readCalled = true
		return "", &fakeErr{"path is required"}
	}})
	ag.WithTool(agentcore.ToolFunc{N: "bash", Fn: func(_ context.Context, _ string) (string, error) {
		bashCalled = true
		return "ok", nil
	}})
