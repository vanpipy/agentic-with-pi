...
func TestLsLimit(t *testing.T) {
	...
	tool := tools.Ls(dir, tools.FileOptions{})
	out, err := tool.Invoke(context.Background(), `{"limit":2,"intent":"test"}`)
	if err != nil {
		t.Fatal(err)
	}
...
func TestLsMissing(t *testing.T) {
	dir := t.TempDir()
	tool := tools.Ls(dir, tools.FileOptions{})
	_, err := tool.Invoke(context.Background(), `{"path":"nonexistent","intent":"test"}`)
	if err == nil {
...
func TestFindGlob(t *testing.T) {
	...
	out, err := tool.Invoke(context.Background(), `{"pattern":"*.go","intent":"test"}`)
	if err != nil {
		t.Fatal(err)
	}
...
func TestFindLimit(t *testing.T) {
	...
	tool := tools.Find(dir, tools.FileOptions{})
	out, err := tool.Invoke(context.Background(), `{"pattern":"*.txt","limit":3,"intent":"test"}`)
	if err != nil {
		t.Fatal(err)
	}
	lines := strings.Split(strings.TrimSpace(out), "\n")
...
func TestFindNoMatch(t *testing.T) {
	dir := t.TempDir()
	tool := tools.Find(dir, tools.FileOptions{})
	out, err := tool.Invoke(context.Background(), `{"pattern":"*.xyz","intent":"test"}`)
	if err != nil {
		t.Fatal(err)
	}
...
func TestGrepPattern(t *testing.T) {
	...
	out, err := tool.Invoke(context.Background(), `{"pattern":"hello","intent":"test"}`)
	if err != nil {
		t.Fatal(err)
	}
...
func TestGrepIgnoreCase(t *testing.T) {
	...
	tool := tools.Grep(dir, tools.FileOptions{})
	out, err := tool.Invoke(context.Background(), `{"pattern":"hello","ignoreCase":true,"intent":"test"}`)
	if err != nil {
		t.Fatal(err)
	}
...
func TestGrepLiteral(t *testing.T) {
	...
	tool := tools.Grep(dir, tools.FileOptions{})
	out, err := tool.Invoke(context.Background(), `{"pattern":"a.b.c","literal":true,"intent":"test"}`)
	if err != nil {
		t.Fatal(err)
	}
...
func TestGrepGlob(t *testing.T) {
	...
	tool := tools.Grep(dir, tools.FileOptions{})
	out, err := tool.Invoke(context.Background(), `{"pattern":"match","glob":"*.go","intent":"test"}`)
	if err != nil {
		t.Fatal(err)
	}
